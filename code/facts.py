#i am currently working on an "image to text", these lines are an output of that project from my little cousins summer homework which was then parsed through an LLM to factcheck/correct spelling mistakes
...
with open("owl_facts.txt", "w") as f:
    for fact in facts:
        f.write(fact + "\n")

print("🦉 owl_facts.txt created!")
